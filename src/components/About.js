  ...
  return (
    <Container>
      <Stack id='1' direction={{ xs: 'column', sm: 'row' }} pt={{ xs: 10, sm: 20 }} pb={{ xs: 10, sm: 20 }} pl={{ xs: 1, sm: 2, md: 15 }} pr={{ xs: 1, sm: 2, md: 15 }} spacing={3} alignItems={{ xs: 'center', sm: 'flex-start' }} justifyContent='center'>
        ...
        <Box width='100%'>
          <Typography mt={1} className='name-personal' variant="h4" component='h1' fontWeight='bold' textAlign={{ xs: 'center', sm: 'left' }}>Pablo Hajnal</Typography>
          <Typography mt={1} ml={{ xs: 0, sm: 1 }} variant="h6" component='p' fontSize={16} color='#e0e0e0'>
