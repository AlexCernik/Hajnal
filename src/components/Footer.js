...
const Footer = () => {
  return (
    <Stack alignSelf='center' mt={5} pl={10} pr={10} pt={5} pb={5} style={{ justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(62, 66, 73, 0.91)', boxShadow: '0px 2px 3px 1px rgba(0,0,0,0.9)' }}>
